...
public class JobsFlowAssignRough extends RegressionSuiteBase{
	...
	public void jobsFlowAssignJobRough(Hashtable<String, String>data) throws InterruptedException{
		...
		/*for storing the count value of the assignments in the Assignments Page*/
		waitForElement(10, "assignLinKX");
		getObject("assignLinKX").click();
		/*waitForElementId(10, "assignmentNowShowingId");
		String AssignmentText = getObjectById("assignmentNowShowingId").getText();
		Thread.sleep(5000);
		System.out.println(AssignmentText);
	    Thread.sleep(8000);
		String[] words = AssignmentText.split("\\s+");
		...
		/*System.out.println(AssignmentText);
		String abc;
		abc = stringSplit(AssignmentText);
		System.out.println(abc);*/
		//System.out.println(abc[7]);
		//String a = AssignmentText;
	   // Thread.sleep(5000);
		/*String a[] = AssignmentText.split(" ");
		System.out.println(a[7]);
		String assignmentTotalNum=a[7];*/
		
		
		driver.navigate().back();
		
		waitForElement(10, "jobsLinkX");
		 //stringSplit(getObjectById("assignmentNowShowingId").getText());
	   ...
	   // explicitWaitXpath("assignCandidateCommentsX");
	    ...
	    Thread.sleep(5000);
	  // waitForElement(10, "dashBoardLinkX");
	   driver.navigate().back();
	   // getObject("dashBoardLinkX").click();
	   waitForElementId(10, "unassignedJobsCountId");
	    Thread.sleep(5000);
	...
	/*	waitForElement(10, "assignLinKX");
		getObject("assignLinKX").click();
		String AssignmentText1 = getObjectById("assignmentNowShowingId").getText();
		String b = AssignmentText1;
		String assignmentTotalNumAfter = stringSplit(b);
		System.out.println(assignmentTotalNumAfter);
		*/
		//checkAssignmentIncrement(assignmentTotalNum, assignmentTotalNumAfter);
		...
		String AssignmentText1 = getObjectById("assignmentNowShowingId").getText();
		//String a = AssignmentText;
		System.out.println(AssignmentText1);
		//String a = AssignmentText;
	   // Thread.sleep(5000);
		String b[] = AssignmentText1.split(" ");
		System.out.println(a[7]);
		String assignmentTotalNumAfter = a[7];

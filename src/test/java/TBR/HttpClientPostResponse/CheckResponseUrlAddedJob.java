package TBR.HttpClientPostResponse;
...
public class CheckResponseUrlAddedJob {
            ...
            HttpUriRequest web = RequestBuilder.post().setUri(new URI(SERVER_NAME + "/web/rec/add/job/"))
            		                    .addParameter("address", "dublin 1")
                         				...
                         				.addParameter("details[clientid]", "193")
                         				.addParameter("details[clientname]", "apple")
                         				.addParameter("details[description]", "")
                         				.addParameter("details[externalRef]", "")

...
public class JobsFlowDontMatchChangeMargin extends RegressionSuiteBase {
	
	 @DataProvider
		public Object[][] getDontMatchSaveJobChangeMarginData(){
	    return TestUtil.getDataIntoHashTable(JobsExcel, "JobsFlowChangeMarginDontMatch");
		}
		@Test(dataProvider="getDontMatchSaveJobChangeMarginData")
		public void jobsFlowChangeMargin(Hashtable<String, String>data) throws InterruptedException{
			openBrowser();
		    ...
		    getObjectById("marginId").clear();
		    getObjectById("marginId").sendKeys(data.get("MarginStep3"));
		    ...
		    Assert.assertEquals(getObjectByIdValue("totalId"), c);
